...
class Maze:
    ...
    def __move(self, state, action, return_all_possible=False):  # , action_m
        ...
        # print("self.states[state][0]", self.states[state][0])
            ...
            for a in range(self.n_actions):
                ...
                for next_s in possible_states:
                    ...
                    if (self.states[next_s][0], self.states[next_s][1]) == (
                            self.states[next_s][2], self.states[next_s][3]):
                        tmp += self.IMPOSSIBLE_REWARD
                    # reward for hitting a wall
                    elif (self.states[s][0], self.states[s][1]) == (
                            self.states[next_s][0], self.states[next_s][1]) and a != self.STAY:
                        tmp += self.IMPOSSIBLE_REWARD
                    # reward for reaching the exit
                    elif (self.states[s][0], self.states[s][1]) == (self.states[next_s][0], self.states[next_s][1]) and \
                            self.maze[(self.states[next_s][0], self.states[next_s][1])] == 2:
